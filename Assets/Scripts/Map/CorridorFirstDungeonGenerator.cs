...
public class CorridorFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private void createRoomAtDeadEnd(List<Vector2Int> deadEnds, HashSet<Vector2Int> roomFloors)
    {
        foreach (var position in deadEnds)
        {
            ...
            {
                var room = RunRadomWalk(randomWalkParameters, position);
    ...
    private HashSet<Vector2Int> createRooms(HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var roomFloor = RunRadomWalk(randomWalkParameters, roomPosition);
    ...
    private List<List<Vector2Int>> CreateCorridors(HashSet<Vector2Int> floorPositions, HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var corridor = ProceduralGenerationAlgorilthms.RandomWalkCorridor(currentPosition, corridorLength);

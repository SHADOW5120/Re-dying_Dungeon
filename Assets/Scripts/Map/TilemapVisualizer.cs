...
public class TilemapVisualizer : MonoBehaviour
{
    ...
    internal void PaintSingleCornerWall(Vector2Int poistion, string bianryType)
    {
        int typeAsInt = Convert.ToInt32(bianryType, 2);
        TileBase tile = null;
        ...
        if (tile != null) PaintSingleTile(wallTilemap, tile, poistion);
    }

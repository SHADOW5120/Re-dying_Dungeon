...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    {
        var roomsList = ProceduralGenerationAlgorilthms.BinarySpacePartitioning(new BoundsInt((Vector3Int)startPosition, new Vector3Int(dungeonWidth, dungeonHeight, 0)), minRoomWidth, minRoomHeight);
    ...
    private HashSet<Vector2Int> CreateRoomsRandomly(List<BoundsInt> roomsList)
    {
        ...
        for (int i = 0; i < roomsList.Count; i++)
        {
            ...
            var roomFloor = RunRadomWalk(randomWalkParameters, roomCenter);
